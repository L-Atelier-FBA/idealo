...
JSON_URL = "https://raw.githubusercontent.com/L-Atelier-FBA/idealo_bs/refs/heads/main/products.jsonl"
...
async def fetch_cookies(session):
    ...
    try:
        async with session.get(COOKIE_URL, timeout=60) as response:
            ...
            result = {
                "amazon": cookie.get("amazon3"),
                "seller": cookie.get("amazon4"),
            }
